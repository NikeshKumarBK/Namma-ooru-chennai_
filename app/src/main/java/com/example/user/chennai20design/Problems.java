...
public class Problems extends ListActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.newProb);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Problems.this,NewProblemActivity.class);
    ...
    public void btnClickProbSolved(View v)
    {
        ...
        Button btnChild = (Button)vwParentRow.getChildAt(6);
    ...
    class SaveProductDetails extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Problems.this);
        ...
        protected void onPostExecute(String file_url) {
            ...
            pDialog.dismiss();
            Intent intent=new Intent(Problems.this,Problems.class);
            startActivity(intent);
            finish();
        }
    }
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            Intent intent=new Intent(Problems.this,FirstScreen.class);
            startActivity(intent);
            finish();
        }
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            Intent intent=new Intent(Problems.this,MonumentsNavDrawer.class);
            startActivity(intent);
            finish();
        } else if (id == R.id.nav_gallery) {
            Intent intent=new Intent(Problems.this,SpiritualNavDrawer.class);
            startActivity(intent);
            finish();
        } else if (id == R.id.nav_slideshow) {
            Intent intent=new Intent(Problems.this,NatParkNavDrawer.class);
            startActivity(intent);
            finish();
            ...
            Intent intent=new Intent(Problems.this,About.class);
            startActivity(intent);
            finish();
        }
